              ...
              <div className="xl:w-10/12">
                <div className="block bg-white shadow-lg rounded-lg">
                  <div className="lg:flex lg:flex-wrap g-0">
                      ...
                      <div className="md:p-12 md:mx-6">
                        <div className="text-center">
                          <Image
                            ...
                            alt="Dow Dash Logo"
                          />
                          <h4 className="text-xl font-semibold mt-1 mb-12 pb-1">Dow dashboard login</h4>
                        </div>
                    ...
                    <div
                      className="hidden lg:flex lg:w-6/12 items-center bg-slate-900 lg:rounded-r-lg rounded-b-lg lg:rounded-bl-none"
                    >
